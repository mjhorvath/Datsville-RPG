...
// Commandline:  "E:\Programs Windows\l3p14beta\l3p.exe" "D:\Datsville RPG\trunk\povray_source\pov_main_project\characters\character_001_maincharacter.ldr" "D:\Datsville RPG\trunk\povray_source\pov_main_project\characters\character_001_maincharacter_face.pov" -o -ic -il -ibcharacter_face.inc
...
// render at 512x512 pixels
camera
{
	//orthographic
	up		-y * 160 * image_height/image_width
	right		+x * 160
	location	-z * 1024
	direction	+z * 1024
	translate	-y * 60
...
texture {
	pigment { srgb <r/255,g/255,b/255> }
...
texture {
	pigment { srgb <r/255,g/255,b/255> #if (L3Quality > 1) filter f #end }

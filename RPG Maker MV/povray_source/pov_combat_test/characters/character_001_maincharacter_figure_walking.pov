...
#declare M_R_Arm_Color=L3Color378; // Default right arm color: gray
#declare M_L_Arm_Color=L3Color378; // Default left armcolor: gray
#declare M_R_Hand_Color=L3Color14; // Default right arm color: gray
#declare M_L_Hand_Color=L3Color14; // Default left armcolor: gray
#declare M_Torso_Color=L3Color378; // Default torso color: gray
#declare M_Hips_Color=L3Color8; // Default hips color: black 
#declare M_Hat_Color=L3Color379; // Default hat color: gray

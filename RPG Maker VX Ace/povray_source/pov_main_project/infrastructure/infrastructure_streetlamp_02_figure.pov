...
// Date:         Mon Aug 18 09:35:47 2014
// Input file:   D:\Datsville\trunk\datsville_boxed\infrastructure_streetlamp_02.ldr
...
// Commandline:  "E:\Programs Windows\l3p14beta\l3p.exe" D:\Datsville\trunk\datsville_boxed\infrastructure_streetlamp_02.ldr -o -ic -il -ibbuilding_mapsize_noshadow.inc
...
//// Part b\4740.dat
#ifndef (b_slash_4740_dot_dat)
#declare b_slash_4740_dot_dat = #if (L3Quality = 0) box { <-20,0,-20>, <20,8,20> } #else union {
// Dish  2 x  2 Inverted
// Name: 4740.dat
// Author: James Jessiman
...
#end
#end // ifndef (b_slash_4740_dot_dat)
...
// ROTATION CONFIG 0 0
	...
	// 1 288  0 -200 0  1 0 0  0 1 0  0 0 1 b\4740.dat
	object {
		b_slash_4740_dot_dat
...
//// ModelData
#declare L3ModelBBoxMin = <-20,-200,-20>;
#declare L3ModelBBoxMax = <20,0,20>;
#declare L3ModelBBoxCenter = (L3ModelBBoxMin+L3ModelBBoxMax)/2; // <0,-100,0>
#declare L3ModelBBoxSize = L3ModelBBoxMax-L3ModelBBoxMin; // <40,200,40>
#declare L3FloorY = L3ModelBBoxMax.y;

//// ModelObject infrastructure_streetlamp_02.ldr
object { infrastructure__streetlamp__02_dot_ldr }
